...
class MspsStatsControllerTests(ControllerTestBase):

    @classmethod
    def setUpClass(cls):
        super(MspsStatsControllerTests, cls).setUpClass()
        cls.controller = cls.client.msps_stats
        cls.response_catcher = cls.controller.http_call_back

    # Get List of MSP Licences
    def test_list_msp_org_licenses(self):
        # Parameters for the API call
        msp_id = '000000ab-00ab-00ab-00ab-0000000000ab'

        # Perform the API call through the SDK function
        result = self.controller.list_msp_org_licenses(msp_id)
    ...
    def test_list_msp_org_stats(self):
        # Parameters for the API call
        msp_id = '000000ab-00ab-00ab-00ab-0000000000ab'
        page = 1
        limit = 100
        ...
        # Perform the API call through the SDK function
        result = self.controller.list_msp_org_stats(msp_id, page, limit)
