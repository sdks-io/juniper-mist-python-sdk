...
from mistapi.models.result_23 import Result23


class RrmEvents(object):

    """Implementation of the 'RrmEvents' model.
    ...
    Attributes:
        ...
        next (string): the link to query next set of results. value is null if
            no next page exists.
        results (list of Result23): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 next=APIHelper.SKIP):
        """Constructor for the RrmEvents class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result23.from_dictionary(x) for x in dictionary.get('results')]
