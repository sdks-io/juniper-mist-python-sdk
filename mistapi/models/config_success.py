...
from mistapi.models.details_4 import Details4


class ConfigSuccess(object):

    """Implementation of the 'ConfigSuccess' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ConfigSuccess class"""
    ...
    def from_dictionary(cls,
        ...
        details = Details4.from_dictionary(dictionary.get('details')) if 'details' in dictionary.keys() else APIHelper.SKIP
