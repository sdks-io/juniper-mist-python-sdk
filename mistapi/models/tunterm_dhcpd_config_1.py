...
class TuntermDhcpdConfig1(object):

    """Implementation of the 'TuntermDhcpdConfig1' model.

    global and per-VLAN. The property key is the VLAN ID

    Attributes:
        enabled (bool): TODO: type description here.
        servers (list of string): list of DHCP servers; required if
            `type`==`relay`
    ...
    def __init__(self,
                 ...
                 mtype='relay'):
        """Constructor for the TuntermDhcpdConfig1 class"""
