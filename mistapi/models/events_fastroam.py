...
from mistapi.models.result_16 import Result16


class EventsFastroam(object):

    """Implementation of the 'EventsFastroam' model.
    ...
    Attributes:
        ...
        next (string): the link to query next set of results. value is null if
            no next page exists.
        results (list of Result16): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 next=APIHelper.SKIP):
        """Constructor for the EventsFastroam class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result16.from_dictionary(x) for x in dictionary.get('results')]
