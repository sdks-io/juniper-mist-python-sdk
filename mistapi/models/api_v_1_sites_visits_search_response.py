...
"""
from mistapi.models.result_30 import Result30


class ApiV1SitesVisitsSearchResponse(object):

    """Implementation of the 'Api V1 Sites Visits Search Response' model.
    ...
    Attributes:
        ...
        results (list of Result30): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SitesVisitsSearchResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result30.from_dictionary(x) for x in dictionary.get('results')]
