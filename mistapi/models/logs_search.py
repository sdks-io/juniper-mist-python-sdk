...
from mistapi.models.result_3 import Result3


class LogsSearch(object):

    """Implementation of the 'LogsSearch' model.
    ...
    Attributes:
        ...
        results (list of Result3): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the LogsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result3.from_dictionary(x) for x in dictionary.get('results')]
