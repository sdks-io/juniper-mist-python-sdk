...
class ApiV1SitesMapsClearAutoplacementRequest(object):

    """Implementation of the 'Api V1 Sites Maps Clear Autoplacement Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ApiV1SitesMapsClearAutoplacementRequest class"""
