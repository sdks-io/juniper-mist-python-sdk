...
from mistapi.models.result_24 import Result24


class ApiV1SitesStatsDiscoveredSwitchMetricsSearchResponse(object):

    """Implementation of the 'Api V1 Sites Stats Discovered Switch Metrics Search Response' model.
    ...
    Attributes:
        ...
        results (list of Result24): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the ApiV1SitesStatsDiscoveredSwitchMetricsSearchResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result24.from_dictionary(x) for x in dictionary.get('results')]
