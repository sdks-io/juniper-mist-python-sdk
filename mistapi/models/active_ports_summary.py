...
from mistapi.models.details_3 import Details3


class ActivePortsSummary(object):

    """Implementation of the 'ActivePortsSummary' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ActivePortsSummary class"""
    ...
    def from_dictionary(cls,
        ...
        details = Details3.from_dictionary(dictionary.get('details')) if 'details' in dictionary.keys() else APIHelper.SKIP
