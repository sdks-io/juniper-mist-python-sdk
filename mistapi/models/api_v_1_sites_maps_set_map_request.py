...
class ApiV1SitesMapsSetMapRequest(object):

    """Implementation of the 'Api V1 Sites Maps Set Map Request' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ApiV1SitesMapsSetMapRequest class"""
