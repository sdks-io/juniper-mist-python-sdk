...
from mistapi.models.webhook_delivery import WebhookDelivery


class WebhookDeliverySearch(object):

    """Implementation of the 'WebhookDeliverySearch' model.
    ...
    Attributes:
        ...
        results (list of WebhookDelivery): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the WebhookDeliverySearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [WebhookDelivery.from_dictionary(x) for x in dictionary.get('results')]
        else:
            results = APIHelper.SKIP
