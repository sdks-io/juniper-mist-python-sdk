...
from mistapi.models.result_11 import Result11


class ConfigsHistorySearch(object):

    """Implementation of the 'ConfigsHistorySearch' model.
    ...
    Attributes:
        ...
        results (list of Result11): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the ConfigsHistorySearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result11.from_dictionary(x) for x in dictionary.get('results')]
