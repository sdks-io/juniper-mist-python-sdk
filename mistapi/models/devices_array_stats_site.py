...
from mistapi.models.ip_stat_5 import IpStat5
from mistapi.models.l_2_tp_stat import L2tpStat
from mistapi.models.last_trouble_3 import LastTrouble3
from mistapi.models.led import Led
from mistapi.models.lldp_stat import LldpStat
from mistapi.models.memory_stat_4 import MemoryStat4
from mistapi.models.mesh_downlinks import MeshDownlinks
from mistapi.models.mesh_uplink import MeshUplink
from mistapi.models.module_stat_3 import ModuleStat3
from mistapi.models.num_clients_1 import NumClients1
...
class DevicesArrayStatsSite(object):

    """Implementation of the 'DevicesArrayStatsSite' model.
    ...
    Attributes:
        ...
        ip_stat (IpStat5): TODO: type description here.
        l_2_tp_stat (dict): l2tp tunnel status (key is the wxtunnel_id)
        last_seen (float): last seen timestamp
        last_trouble (LastTrouble3): last trouble code of switch
        ...
        num_clients (NumClients1): how many wireless clients are currently
            connected
        ...
        memory_stat (MemoryStat4): memory usage stat (for virtual chassis,
            memory usage of master RE)
        module_stat (list of ModuleStat3): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the DevicesArrayStatsSite class"""
    ...
    def from_dictionary(cls,
        ...
        ip_stat = IpStat5.from_dictionary(dictionary.get('ip_stat')) if 'ip_stat' in dictionary.keys() else APIHelper.SKIP
        ...
        last_trouble = LastTrouble3.from_dictionary(dictionary.get('last_trouble')) if 'last_trouble' in dictionary.keys() else APIHelper.SKIP
        ...
        num_clients = NumClients1.from_dictionary(dictionary.get('num_clients')) if 'num_clients' in dictionary.keys() else APIHelper.SKIP
        ...
        memory_stat = MemoryStat4.from_dictionary(dictionary.get('memory_stat')) if 'memory_stat' in dictionary.keys() else APIHelper.SKIP
        module_stat = None
        if dictionary.get('module_stat') is not None:
            module_stat = [ModuleStat3.from_dictionary(x) for x in dictionary.get('module_stat')]
        else:
            module_stat = APIHelper.SKIP
