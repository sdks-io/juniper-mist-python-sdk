...
from mistapi.models.result_5 import Result5


class OrgsSearch(object):

    """Implementation of the 'OrgsSearch' model.
    ...
    Attributes:
        ...
        results (list of Result5): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the OrgsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result5.from_dictionary(x) for x in dictionary.get('results')]
