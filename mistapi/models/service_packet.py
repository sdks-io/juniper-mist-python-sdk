...
class ServicePacket(object):
    ...
    """Implementation of the 'ServicePacket' model.

    TODO: type model description here.

    Attributes:
        service_data (string): ata from service data
        service_uuid (string): UUID from service data
    ...
    def __init__(self,
        ...
        """Constructor for the ServicePacket class"""
