...
"""
from mistapi.models.result_25 import Result25


class ApiV1SitesStatsDiscoveredSwitchesCountResponse(object):

    """Implementation of the 'Api V1 Sites Stats Discovered Switches Count Response' model.
    ...
    Attributes:
        ...
        results (list of Result25): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SitesStatsDiscoveredSwitchesCountResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result25.from_dictionary(x) for x in dictionary.get('results')]
