...
from mistapi.models.stats_bgp import StatsBgp


class BgpStatsArraySearch(object):

    """Implementation of the 'BgpStatsArraySearch' model.
    ...
    Attributes:
        ...
        results (list of StatsBgp): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the BgpStatsArraySearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [StatsBgp.from_dictionary(x) for x in dictionary.get('results')]
        else:
            results = APIHelper.SKIP
