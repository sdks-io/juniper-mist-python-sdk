...
from mistapi.models.wired_client_response import WiredClientResponse


class WiredClientsSearch(object):

    """Implementation of the 'WiredClientsSearch' model.
    ...
    Attributes:
        ...
        results (list of WiredClientResponse): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the WiredClientsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [WiredClientResponse.from_dictionary(x) for x in dictionary.get('results')]
