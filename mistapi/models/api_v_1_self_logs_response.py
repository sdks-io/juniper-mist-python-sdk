...
"""
from mistapi.models.result_9 import Result9


class ApiV1SelfLogsResponse(object):

    """Implementation of the 'Api V1 Self Logs Response' model.
    ...
    Attributes:
        ...
        results (list of Result9): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SelfLogsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result9.from_dictionary(x) for x in dictionary.get('results')]
