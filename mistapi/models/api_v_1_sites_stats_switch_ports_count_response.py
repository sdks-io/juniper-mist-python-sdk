...
class ApiV1SitesStatsSwitchPortsCountResponse(object):

    """Implementation of the 'Api V1 Sites Stats Switch Ports Count Response' model.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SitesStatsSwitchPortsCountResponse class"""
