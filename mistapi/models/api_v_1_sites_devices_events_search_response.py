...
"""
from mistapi.models.events_device_ap import EventsDeviceAp


class ApiV1SitesDevicesEventsSearchResponse(object):

    """Implementation of the 'Api V1 Sites Devices Events Search Response' model.
    ...
    Attributes:
        ...
        results (list of EventsDeviceAp): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SitesDevicesEventsSearchResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [EventsDeviceAp.from_dictionary(x) for x in dictionary.get('results')]
