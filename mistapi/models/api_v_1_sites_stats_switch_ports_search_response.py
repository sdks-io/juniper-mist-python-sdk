...
class ApiV1SitesStatsSwitchPortsSearchResponse(object):

    """Implementation of the 'Api V1 Sites Stats Switch Ports Search Response' model.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SitesStatsSwitchPortsSearchResponse class"""
