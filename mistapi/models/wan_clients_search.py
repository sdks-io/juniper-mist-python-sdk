...
from mistapi.models.stats_clients_wan import StatsClientsWan


class WanClientsSearch(object):

    """Implementation of the 'WanClientsSearch' model.
    ...
    Attributes:
        ...
        results (StatsClientsWan): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the WanClientsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        results = StatsClientsWan.from_dictionary(dictionary.get('results')) if 'results' in dictionary.keys() else APIHelper.SKIP
