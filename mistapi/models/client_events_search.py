...
from mistapi.models.events_client import EventsClient


class ClientEventsSearch(object):

    """Implementation of the 'ClientEventsSearch' model.
    ...
    Attributes:
        ...
        results (list of EventsClient): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the ClientEventsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [EventsClient.from_dictionary(x) for x in dictionary.get('results')]
