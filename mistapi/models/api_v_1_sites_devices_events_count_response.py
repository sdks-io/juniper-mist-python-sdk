...
"""
from mistapi.models.result_13 import Result13


class ApiV1SitesDevicesEventsCountResponse(object):

    """Implementation of the 'Api V1 Sites Devices Events Count Response' model.
    ...
    Attributes:
        ...
        results (list of Result13): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the ApiV1SitesDevicesEventsCountResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result13.from_dictionary(x) for x in dictionary.get('results')]
