...
from mistapi.models.chassi import Chassi


class SleImpactedChassis(object):

    """Implementation of the 'sle_impacted_chassis' model.

    TODO: type model description here.

    Attributes:
        chassis (list of Chassi): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the SleImpactedChassis class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('chassis') is not None:
            chassis = [Chassi.from_dictionary(x) for x in dictionary.get('chassis')]
        else:
            chassis = APIHelper.SKIP
