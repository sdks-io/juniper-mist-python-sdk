...
from mistapi.models.events_skyatp import EventsSkyatp


class ApiV1SitesSkyatpEventsSearchResponse(object):

    """Implementation of the 'Api V1 Sites Skyatp Events Search Response' model.
    ...
    Attributes:
        ...
        results (list of EventsSkyatp): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the ApiV1SitesSkyatpEventsSearchResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [EventsSkyatp.from_dictionary(x) for x in dictionary.get('results')]
