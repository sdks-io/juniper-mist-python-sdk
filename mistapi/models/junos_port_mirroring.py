...
class JunosPortMirroring(object):

    """Implementation of the 'junos_port_mirroring' model.

    TODO: type model description here.

    Attributes:
        egress_port_ids (list of string): at least one of the
            `ingress_port_ids`, `egress_port_ids` or `ingress_networks `
            should be specified
        ingress_networks (list of string): at least one of the
            `ingress_port_ids`, `egress_port_ids` or `ingress_networks `
            should be specified
        ingress_port_ids (list of string): at least one of the
            `ingress_port_ids`, `egress_port_ids` or `ingress_networks `
            should be specified
        output_network (string): TODO: type description here.
        output_port_id (string): exaclty on of the `output_port_id` or
    ...
    def __init__(self,
        ...
        """Constructor for the JunosPortMirroring class"""
