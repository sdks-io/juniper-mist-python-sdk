...
class AssetsArrayStatsSearch(object):

    """Implementation of the 'AssetsArrayStatsSearch' model.
    ...
    Attributes:
        ...
        results (list of StatsAsset): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the AssetsArrayStatsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [StatsAsset.from_dictionary(x) for x in dictionary.get('results')]
