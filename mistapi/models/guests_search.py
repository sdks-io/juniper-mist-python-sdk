...
"""
from mistapi.models.result_18 import Result18


class GuestsSearch(object):

    """Implementation of the 'GuestsSearch' model.
    ...
    Attributes:
        ...
        results (list of Result18): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 start=None,
                 total=None):
        """Constructor for the GuestsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result18.from_dictionary(x) for x in dictionary.get('results')]
