...
from mistapi.models.events_rogue import EventsRogue


class RogueEventsSearch(object):

    """Implementation of the 'RogueEventsSearch' model.
    ...
    Attributes:
        ...
        results (list of EventsRogue): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the RogueEventsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [EventsRogue.from_dictionary(x) for x in dictionary.get('results')]
