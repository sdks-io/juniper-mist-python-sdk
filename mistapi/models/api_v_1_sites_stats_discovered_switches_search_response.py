...
from mistapi.models.result_26 import Result26


class ApiV1SitesStatsDiscoveredSwitchesSearchResponse(object):

    """Implementation of the 'Api V1 Sites Stats Discovered Switches Search Response' model.
    ...
    Attributes:
        ...
        results (list of Result26): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the ApiV1SitesStatsDiscoveredSwitchesSearchResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result26.from_dictionary(x) for x in dictionary.get('results')]
