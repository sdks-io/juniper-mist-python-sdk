...
class DhcpFailure(object):

    """Implementation of the 'DhcpFailure' model.
    ...
    def __init__(self,
                 ...
                 duration=10,
                 incident_count=20):
        """Constructor for the DhcpFailure class"""
    ...
    def from_dictionary(cls,
        ...
        incident_count = dictionary.get("incident_count") if dictionary.get("incident_count") else 20
