...
"""
from mistapi.models.result_20 import Result20


class InsightRogueClients(object):

    """Implementation of the 'InsightRogueClients' model.
    ...
    Attributes:
        ...
        results (list of Result20): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 results=None,
                 start=None):
        """Constructor for the InsightRogueClients class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Result20.from_dictionary(x) for x in dictionary.get('results')]
