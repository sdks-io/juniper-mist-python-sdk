...
from mistapi.models.alarm import Alarm


class AlarmsSearch(object):

    """Implementation of the 'AlarmsSearch' model.
    ...
    Attributes:
        ...
        results (list of Alarm): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 total=None,
                 next=APIHelper.SKIP):
        """Constructor for the AlarmsSearch class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('results') is not None:
            results = [Alarm.from_dictionary(x) for x in dictionary.get('results')]
